...
import com.lwan.rkswl.ezen_project.adapter.PlusImageAdapter;
import com.lwan.rkswl.ezen_project.plusImageFIle;
...
public class PlusActivity extends AppCompatActivity {
    ...
    @BindView(R.id.plus_rl_picture) RelativeLayout plus_rl_picture;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        plus_rl_picture.setOnClickListener(new View.OnClickListener() {
            @Override
